...
export default function OrderVerification() {
  ...
  // Retrieve the 'order_id' parameter
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <dl className="grid grid-cols-2 gap-2">
              <dt className="font-semibold">Transaction Status:</dt>
              <dd>{orderData.transaction_status}</dd>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Link to="/order">
              <Button className="mt-5 w-full">View Orders</Button>
            </Link>
          </CardContent>
          <CardFooter>
